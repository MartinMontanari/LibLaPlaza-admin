...
class UpdateProductSchema
{
    ...
    {
        return [
            'id.min' => 'El producto seleccionado no es correcto.',
            'id.integer' => 'El producto seleccionado no es correcto.',
            ...
            'description.min' => 'La descripción ingresada es demasiado corta.',
            'description.max' => 'La descripción ingresada es demasiado larga.',
