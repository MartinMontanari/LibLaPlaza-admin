                    ...
                    <div class="form-group-sm">
                        <form id="form" action="{{route('store-sale')}}" method="POST">
                            ...
                            <div class="form-group-lg">
                                ...
                                <input type="text" class="form-control" name="fullName" min="1" max="20" maxlength="20"
                                       placeholder="Nombre y apellido"
                                       value="{{old('fullName')}}" required>
                                <label>Dni del cliente: </label>
                                <input type="text" class="form-control" name="dni" min="7" max="15" maxlength="15"
                                       placeholder="DNI"
                                       value="{{old('dni')}}" required><br>
                                <label>Tipo comprobante:</label>
                                <select class="form-control select2-blue" name="billType" required>
